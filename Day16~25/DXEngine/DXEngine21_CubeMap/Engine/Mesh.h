...
public:
	...
	Mesh(LPCSTR fbxName, LPCTSTR shaderName, D3D11_FILL_MODE fillMode = D3D11_FILL_SOLID, D3D11_CULL_MODE cullMode = D3D11_CULL_BACK);
	~Mesh();
...
private:
	...
	// 래스터라이저 스테이트 관련.
	D3D11_FILL_MODE fillMode;						//기본값: SOLID
	D3D11_CULL_MODE cullMode;						//기본값: 앞면그리기
