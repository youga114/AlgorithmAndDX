...
void Engine::Render(float deltaTime)
{
	...
	rtRenderer->UpdateBuffers(deviceContext, 600, 100);
	rtRenderer->RenderBuffers(deviceContext);

	rtRenderer->UpdateBuffers(deviceContext, 1100, 100);
	rtRenderer->RenderBuffers(deviceContext);
...
bool Engine::InitializeScene()
{
	...
	LPCTSTR coitTowerTexture = TEXT("Resources/Textures/NissiBeach.dds");
	...
	sphere->SetScale(10000.0f, 10000.0f, 10000.0f);
