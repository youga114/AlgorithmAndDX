...
public:
	...
	bool Initialize(ID3D11Device* device, ID3DBlob* vertexShaderBuffer, Camera* camera, UINT screenWidth, UINT screenHeight);
...
private:
	...
	XMMATRIX view = DirectX::XMMatrixIdentity();					//DirectX::XMMatrixIdentity() - 0으로 초기화 해주는 함수.
