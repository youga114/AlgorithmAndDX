...
bool Mesh::InitializeBuffers(ID3D11Device * device, ID3DBlob * vertexShaderBuffer)
{
	...
	Vertex vertices[] = {						//화면 가운데 0좌표(위치) 
		Vertex(XMFLOAT3(-0.5f, 0.5f, 0.5f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f), XMFLOAT2(-1.0f, -1.0f)),
		Vertex(XMFLOAT3(0.5f, 0.5f, 0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f), XMFLOAT2(2.0f, -1.0f)),
		Vertex(XMFLOAT3(0.5f, -0.5f, 0.5f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f), XMFLOAT2(2.0f, 2.0f)),
		Vertex(XMFLOAT3(-0.5f, -0.5f, 0.5f), XMFLOAT4(0.5f, 0.5f, 0.0f, 1.0f), XMFLOAT2(-1.0f, 2.0f))
	};
